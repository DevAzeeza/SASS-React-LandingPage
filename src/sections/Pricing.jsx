    ...
    <section>
      <Element name="pricing">
        <div className="container">
          ...
          border-r border-s2 bg-s1/50 pb-40 pt-28 max-xl:max-w-4xl 
          max-lg:border-none max-md:pb-32 max-md:pt-16"
          >
            <h3
          ...
          max-xl:overflow-auto max-xl:pt-6"
          >
            {plans.map((plan, index) => (
              <div
                key={plan.id}
                className="pricing-plan_first pricing-plan_last
              pricing-plan_odd pricing-plan_even relative border-2 p-7 max-xl:min-w-80 
              max-lg:rounded-3xl xl:w-[calc(33.33%+2px)]"
              >
                {index === 1 && (
                  <div
                    className="g4 absolute h-330 left-0 right-0 top-0
                  z-1 rounded-tl-3xl rounded-tr-3xl"
                  />
                )}
                <div
                  className={clsx(
                ...
                text-p3 before:mx-2.5 before:content-['-'] after:mx-2.5 
                after:content-['-']"
                  >
                    Limited time offer
                  </p>
...
//package for count up or count down in price -  npm install react-countup   useEasing={false} - slowing it up and down as it reaches end   preserve value-keep the last value as you count up to
